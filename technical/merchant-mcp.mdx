...
![Add Kardy in your agent, sign in and choose permissions, then return to your agent.](/images/mcp-oauth-flow.svg)
...
<Tabs>
  <Tab title="Codex">
    ...
    ```sh
    codex mcp add kardy --url https://merchant.getkardy.com/api/mcp
  ...
  <Tab title="Claude Code">
    ...
    ```sh
    claude mcp add --transport http kardy https://merchant.getkardy.com/api/mcp
    ```
