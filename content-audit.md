...
| ------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Signup and phone entry                     | `consumers/src/components/auth-form.tsx`, `consumers/src/lib/phone-validation.ts`, `consumers/src/app/actions/auth.ts`              | `guides/accounts.mdx`, `customer-journey/join.mdx`                                                |
