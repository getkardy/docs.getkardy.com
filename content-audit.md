...
| Public discovery and identity              | `consumers/src/components/marketplace.tsx`, `landing-merchant-features.tsx`, `kardy-wordmark.tsx`                                   | `features/kardy-network.mdx`, `customer-journey/discovery.mdx`                                    |
...
| Dashboard filtering and live activity      | `merchant/src/components/merchant-overview.tsx`, `merchant-activities.tsx`, `merchant/src/app/actions/overview-report.ts`           | `features/analytics.mdx`, `features/activities.mdx`, `features/live-view.mdx`                     |
| Other established features                 | Existing reference pages for rewards, referrals, branding, QR signs, members, outlets, teams, MCP, broadcasts, billing and capacity | Linked from `features/overview.mdx` and `updates.mdx`; existing detailed contracts retained       |
...
- Documented Kardy Network branding and empty published-data states.
