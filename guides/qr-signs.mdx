...
<Steps>
  ...
  <Step title="Choose the design">
    Select a **Design family**, then a design thumbnail. **Studio → Plain** is the
    simple layout shown below; Frame, Ribbon, Soft forms and Geometric offer other looks.
    ...
    **Supporting text**, **Scan label** and **Instructions**. The supporting text
    ...
    Keep the QR dark on its white background. If **QR colour** is too light, Kardy
    falls back to dark ink. Do not crop away the white space around the code.
  ...
  <Step title="Choose a format that fits">
    ...
    <Frame caption="Actual Branding format controls with A6 selected.">
      <img src="/images/guides/qr-format.webp" alt="Square, A4 poster and selected A6 insert options, with the 105 by 148 millimetre dimensions." loading="lazy" width="480" height="330" style={{ width: "100%", maxWidth: "360px", height: "auto", margin: "0 auto" }} />
    </Frame>
...
Set **Background colour** and **Display size** before opening the display.
...
Print design and paper-size choices affect **Match printed sign**, but not the
