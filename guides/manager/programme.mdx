...
## Review reward deadlines

Where available, set the reward claim window to no expiry, one week or one calendar
month after earning. See [reward expiry settings](/features/rewards#set-a-reward-claim-deadline).
This deadline is separate from the temporary QR's 10-minute timer. Explain the
policy to staff and customers; changing the setting does not shorten an already
earned reward's saved deadline. Ask the Owner if you cannot edit the setting.
