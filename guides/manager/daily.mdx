...
## Coach scan approvals

Walk the team through the [stamp and reward approval tutorial](/guides/scanning).
Practise reviewing the member and outlet, releasing a slide early, completing
four checkpoints, and waiting for a confirmed result. Demonstrate the non-drag
confirmation option and the Scan page's sound control.

For rewards, customers prepare a temporary QR first; staff scan it and slide to
redeem. Teach the difference between the 10-minute QR timer and the reward's own
expiry date. If a request is interrupted, check activity before starting another
claim. A sound or animation is not proof of a recorded operation.
...
See [Accounts & access](/guides/accounts) for the full role comparison and
